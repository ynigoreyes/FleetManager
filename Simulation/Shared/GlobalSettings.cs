...
namespace Simulation.Shared
{
    public class GlobalSettings
    {
        ...
        public static Tuple<double, double> Dest1Coord = Tuple.Create<double, double>(WIDTH - 60 - BALL_RADIUS, (HEIGHT / 2) + (BALL_RADIUS + 10));
        public static Tuple<double, double> Dest2Coord = Tuple.Create<double, double>((WIDTH / 2) + (BALL_RADIUS + 10), HEIGHT - BALL_RADIUS - 60);
